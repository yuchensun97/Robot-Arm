...
maxOmegas = [0.5 0.5 0.5 2 3 20]; %Rad/s and mm/s
...
% Calibrations done by Jessica McWilliams on 09/13/19

if strcmpi(robotName, 'Legend')
    % Servo offsets
    servoOffsets = [1200, 1600, 1410, 1450, 1650, 2000];
    servoDirection = [-1,-1,1,-1,1,1];
elseif  strcmpi(robotName, 'Loopy')
    % Servo offsets
    servoOffsets = [1450, 1220, 1470, 1560, 1450, 2000];
    servoDirection = [-1,-1,1,-1,1,1];
elseif  strcmpi(robotName, 'Lucky')
    % Servo offsets
    servoOffsets = [1500, 1600, 1525, 1500, 1460, 2000];
    servoDirection = [-1,-1,1,-1,1,1];
elseif strcmpi(robotName, 'Lyric') 
    % Servo offsets
    servoOffsets = [1575, 1150, 1410, 1470, 1650, 2000];
    servoDirection = [-1,-1,1,-1,1,1];
else
